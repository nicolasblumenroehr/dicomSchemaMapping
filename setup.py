...
setup(
  name = 'dicomSchemaMapping',         # How you named your package folder (MyLib)
  packages = ['dicomSchemaMapping'],   # Chose the same as "name"
  version = '1.0.0',      # Start with a small number and increase it with every change you make
  license='cc',        # Chose a license from here: https://help.github.com/articles/licensing-a-repository
  description = 'A library for mapping dicom metadata attributes into a json schema document',   # Give a short description about your library
  ...
  download_url = 'https://github.com/nicolasblumenroehr/dicomSchemaMapping/archive/refs/tags/1.0.0.tar.gz',    # I explain this later on
