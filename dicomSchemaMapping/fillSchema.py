class fillSchema:
    ...
    def fillArray(self, jsonObject, jsonObjectProperty, jsonArray, newArrayContent):
        if type(newArrayContent)!=type(list()):
            ...
            except: #This condition is done for the case of having multiple array levels for one attribute, because the logic in the next step expects the value of this key, which is of type string, to recieve a 
                #value of type list.
